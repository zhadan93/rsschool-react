...
export const TelegramIcon = (className: string): JSX.Element => {
  return (
    <svg
      version="1.1"
...
export const GithubIcon = (className: string): JSX.Element => {
  return (
    <svg
      fill="none"
      className={classNames('contact-icon', className)}
...
const CONTACT_ICONS: Record<string, (className: string) => JSX.Element> = {
  github: GithubIcon,
